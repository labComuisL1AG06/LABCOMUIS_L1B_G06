...
class punto3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "punto3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto3")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 46000

        ##################################################
        # Blocks
        ##################################################
        self._samp_rate_range = Range(46000, 460000, 1000, 46000, 200)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 7000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 6000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_multiply_xx_0, 2))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_time_sink_x_0, 3))
