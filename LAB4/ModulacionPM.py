...
from EnvolventeComplejaPML1B import EnvolventeComplejaPML1B  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._Kp_range = Range(0, 100, 1, 1, 200)
        ...
        self._Ac_range = Range(0, 1, 0.000001, 1, 200)
        ...
        self.EnvolventeComplejaPML1B_0 = EnvolventeComplejaPML1B(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPML1B_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPML1B_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPML1B_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPML1B_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventeComplejaPML1B_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPML1B_0.set_Ac(self.Ac)
