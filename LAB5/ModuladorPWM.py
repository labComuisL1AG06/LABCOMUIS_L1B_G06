...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ModuladorPWM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ModuladorPWM")
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(-10, 10, 0.01, 0, 200)
        ...
        self._A_range = Range(0, 3, 0.01, 2, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, -1*A+offset, 0)
    ...
    def set_offset(self, offset):
        self.offset = offset
        self.analog_sig_source_x_0_0.set_offset(-1*self.A+self.offset)
    ...
    def set_A(self, A):
        self.A = A
        self.analog_sig_source_x_0_0.set_amplitude(2*self.A)
        self.analog_sig_source_x_0_0.set_offset(-1*self.A+self.offset)
