...
class CalculoPotencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CalculoPotencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "CalculoPotencia")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(0, 20, 1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, A, 0, 0)
...
def main(top_block_cls=CalculoPotencia, options=None):
