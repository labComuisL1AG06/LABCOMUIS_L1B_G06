...
class ModulacionPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._W_range = Range(0, 1000, 1, 50, 200)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(32000, analog.GR_SQR_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(32000, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorPAM_0, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModuladorPAM_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuladorPAM_0_1, 0), (self.blocks_delay_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModuladorPAM_0, 0))
