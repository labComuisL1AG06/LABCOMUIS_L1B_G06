...
class Practica_2_L1B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practica_2_L1B")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica_2_L1B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica_2_L1B")
...
def main(top_block_cls=Practica_2_L1B, options=None):
